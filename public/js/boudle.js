...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var stripe = Stripe('pk_test_51NeqdRJ3Oox2TWhwXPoyalGemLR1iG4nMw1SA7vekVzrB0Pbg4u9GJMMV73mgG4rHH5vFPetaFqCU83dSZGrZXBv00BOGluzGS');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _axios.default)("http://localhost:3000/api/v1/orders/checkout-session/");
        case 3:
...
exports.removeQuantityInCart = exports.removeProductFromCart = exports.clearCart = exports.checkout = exports.addToCart = exports.addQuantityInCart = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var patchToCart = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.patch('http://localhost:3000/api/v1/carts/myCart', {
            items: items
          });
        case 3:
          res = _context.sent;
  ...
  return function patchToCart(_x) {
    return _ref.apply(this, arguments);
  };
}();
var addQuantityInCart = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event) {
    var newPrice, counts, items;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          newPrice = 0;
          counts = document.querySelectorAll('.cart-counter-count');
          ...
          items = Array.from(counts).map(function (el) {
            return {
  ...
  return function addQuantityInCart(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
exports.addQuantityInCart = addQuantityInCart;
var removeQuantityInCart = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          counts.forEach(function (el) {
            if (el.dataset.productId === event.target.dataset.productId) {
              if (el.textContent * 1 - 1 <= 0) (0, _alerts.showAlert)('error', 'Quantity must be positive!');else {
                el.textContent = el.textContent * 1 - 1;
                newPrice = el.textContent * el.dataset.productPrice;
                updatePriceInCart(event.target.dataset.productId, newPrice);
              }
  ...
  return function removeQuantityInCart(_x3) {
    return _ref3.apply(this, arguments);
  };
}();
exports.removeQuantityInCart = removeQuantityInCart;
var updatePriceInCart = function updatePriceInCart(productId, newPrice) {
  var prices = document.querySelectorAll('.cart-item-price');
  prices.forEach(function (el) {
    if (el.dataset.productId === productId) el.textContent = "$".concat(newPrice.toFixed(2));
  });
  var total = Array.from(prices).reduce(function (sum, el) {
    return sum + el.textContent.slice(1) * 1;
  }, 0);
  var totalPrice = document.getElementById('totalPrice');
  totalPrice.textContent = "$".concat(total.toFixed(2));
};
var addToCart = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(productId) {
    var res, cart, exist, items;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          _context4.next = 3;
          return _axios.default.get('http://localhost:3000/api/v1/carts/myCart');
        case 3:
          res = _context4.sent;
          cart = res.data.data;
          exist = false;
          items = cart.items.map(function (el) {
        ...
        case 10:
          (0, _alerts.showAlert)('success', 'Item has been added to the cart!');
          _context4.next = 17;
          break;
        case 13:
          _context4.prev = 13;
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.prev = 0;
          _context5.next = 3;
          return _axios.default.delete('http://localhost:3000/api/v1/carts/myCart');
        case 3:
          (0, _alerts.showAlert)('success', 'Shopping cart has been cleared');
          window.setTimeout(function () {
...
var removeProductFromCart = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(event) {
    var res, cart, productName, items;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 3:
          res = _context6.sent;
          cart = res.data.data;
          items = cart.items.filter(function (el) {
        ...
        case 8:
          (0, _alerts.showAlert)('success', "".concat(productName, " has been removed from cart"));
          window.setTimeout(function () {
            location.assign('/my-cart');
          }, 500);
          _context6.next = 16;
...
var checkout = function checkout(cartId) {};
exports.checkout = checkout;
...
var userNameEmailForm = document.querySelector('.form-user-data');
var userPasswordForm = document.querySelector('.form-user-password');
var addToCartBtns = document.querySelectorAll('.add-to-cart-btn');
var cartPlusBtns = document.querySelectorAll('.cart-counter-btn.plus');
var cartMinusBtns = document.querySelectorAll('.cart-counter-btn.minus');
var clearCartLink = document.getElementById('clearCart');
var removeProductFromCartLinks = document.querySelectorAll('.cart-price-remove');
...
if (userNameEmailForm) {
  userNameEmailForm.addEventListener('submit', /*#__PURE__*/function () {
...
if (addToCartBtns) {
  addToCartBtns.forEach(function (el) {
    el.addEventListener('click', function (e) {
      (0, _cart.addToCart)(e.target.dataset.productId);
    });
  });
}
if (cartPlusBtns) {
  cartPlusBtns.forEach(function (el) {
    el.addEventListener('click', _cart.addQuantityInCart);
  });
}
if (cartMinusBtns) {
  cartMinusBtns.forEach(function (el) {
    el.addEventListener('click', _cart.removeQuantityInCart);
  });
}
if (clearCartLink) {
  clearCartLink.addEventListener('click', _cart.clearCart);
}
if (removeProductFromCartLinks) {
  removeProductFromCartLinks.forEach(function (el) {
    el.addEventListener('click', _cart.removeProductFromCart);
  });
}
...
if (payBtn) {
  payBtn.addEventListener('click', /*#__PURE__*/function () {
...
},{"./login":"login.js","./updateSettings":"updateSettings.js","./stripe":"stripe.js","./cart":"cart.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
